...
<div class='row'>
	...
	<div class='col-md-3'>
		...
		<div class="box box-primary">
			...
			<!-- form start -->
			<form action"#" method="post" id="frmGroup" role="form" novalidate>
				<div class="box-body controls">
					...
					<div class="form-group">
						...
						data-validation-matches-match="email" data-validation-matches-message="Must match email address entered above" >
						 <p class="help-block">mail eingeben</p>
						 </div>
					</div>
...
<!-- validation -->
<script src="{{ asset('/assets/plugins/validation/jqBootstrapValidation.js')}}">
</script>
...
alert("fehvvvler");
                ...
                $("#frmGroup").find("input,textarea,select").jqBootstrapValidation(
                    {
                        preventSubmit: true,
